...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("iclee/ipinfo")
    client.subscribe("iclee/dateinfo")
    client.subscribe("iclee/timeinfo")
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("iclee/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("iclee/dateinfo", on_message_from_dateinfo)
    client.message_callback_add("iclee/timeinfo", on_message_from_timeinfo)
